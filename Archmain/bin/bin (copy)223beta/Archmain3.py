...
menu = tk.Frame(master=window, width=1280, height=40, bg="#303134", highlightthickness=0,highlightbackground = "#0f94d2", highlightcolor= "#0f94d2")
menu.place(x=0, y=85)
...
progress_bk.place(x=46, y=700)
progress=ttk.Progressbar(window,style="x.Horizontal.TProgressbar", orient=HORIZONTAL,length=245,mode='determinate')
progress.place(x=50, y=700)
progress_bk = tk.Frame(master=window, width=245, height=4, bg="#202124", highlightthickness=0,highlightbackground = "#0f94d2", highlightcolor= "#0f94d2")
progress_bk.place(x=50, y=712)
progress_bk = tk.Frame(master=window, width=245, height=4, bg="#202124", highlightthickness=0,highlightbackground = "#0f94d2", highlightcolor= "#0f94d2")
progress_bk.place(x=50, y=700)
labprogress=tk.Entry(window, width=4, font=('SF Pro Display',11), bg="#232429", fg="#b0b3b8", borderwidth = 0, highlightthickness = 0)
labprogress.insert(0," ")
labprogress.place(x=300, y=698)
...
options = tk.Entry(window, width=6, borderwidth = 0, highlightthickness = 0, bg="#404144", fg='#FFF', font=('SF Pro Display',14), insertbackground='#0f94d2' )
options.place(x=500, y=40)
options.insert(0," -S") 
form = tk.Entry(window, width=24, borderwidth = 0, highlightthickness = 0, bg="#404144", fg='#FFF', font=('SF Pro Display',14), insertbackground='#0f94d2' )
form.place(x=580, y=40)
...
form_title.place(x=500, y=12)
btnPkgs=tk.Button(window,  height=1, width=3, text="Run", bg='#0f94d2' , fg="#FFF", font=('SF Pro Display',10), borderwidth = 0, highlightthickness = 0, command=InsRmv)
btnPkgs.place(x=875, y=39)
...
def list_upd(): 
 ...
 lista=Text(master=window,  width=63, height=25,font=('SF Pro Display',11), bg='#303134', fg="#b0b3b8", borderwidth = 0, highlightthickness = 0, )
 lista.place(x=25, y=140,)
...
btn=tk.Button(window, height=0, width=2, text="", font=('SF Pro Display',11),bg="#232429", activebackground="#232429", activeforeground="#f3425f", fg="#b0b3b8", borderwidth = 0, highlightthickness = 0, command=clear_homeCache)
btn.place(x=6, y=309)
...
btn=tk.Button(window, height=0, width=2, text="", font=('SF Pro Display',11), bg="#232429", activebackground="#232429", activeforeground="#f3425f", fg="#b0b3b8", borderwidth = 0, highlightthickness = 0, command=OrphCache)
btn.place(x=6, y=339)
...
btn=tk.Button(window, height=0, width=2, text="", font=('SF Pro Display',11), bg="#232429", activebackground="#232429", activeforeground="#f3425f", fg="#b0b3b8", borderwidth = 0, highlightthickness = 0, command=clear_pkgsCache)
btn.place(x=6, y=369)
...
btn=tk.Button(window, height=1, width=2, text="", font=('SF Pro Display',11), bg="#232429", activebackground="#232429", activeforeground="#0f94d2", fg="#b0b3b8", borderwidth = 0, highlightthickness = 0, command=mirrorlist)
btn.place(x=6, y=396,)
...
country.insert(0, " gb")
btn=tk.Button(window, height=1, width=2, text="", font=('SF Pro Display',11), bg="#232429", activebackground="#232429", activeforeground="#0f94d2", fg="#b0b3b8", borderwidth = 0, highlightthickness = 0, command=reflector).place(x=6, y=426,)
...
btnSet=tk.Button(window,  height=1, width=2, text="",font=('SF Pro Display',11), bg="#232429", activebackground="#232429", activeforeground="#0f94d2", fg="#b0b3b8", borderwidth = 0, highlightthickness = 0, command=lambda:[checkSet_set()])
...
btnSet2=tk.Button(window,  height=1, width=2, text="", font=('SF Pro Display',11), bg="#232429", activebackground="#232429", activeforeground="#0f94d2", fg="#b0b3b8",borderwidth = 0, highlightthickness = 0, command=delay_set)
...
btn=tk.Button(window, height=1, width=2, text="",  font=('SF Pro Display',11), bg="#232429", activebackground="#232429", activeforeground="orange", fg="#b0b3b8", borderwidth = 0, highlightthickness = 0, command=rollback_set)
btn.place(x=6, y=520,)
...
def last_chk():
 ...
 label=tk.Label(window, text="  Last check: ",font=('SF Pro Display',12), fg="#b0b3b8", bg='#303134').place(x=615, y=92,)
 ...
 lastcheck_label.place(x=725, y=93)
...
def message_Delay():
 ...
 messageDelay_label_title.place(x=875, y=92)
 ...
 messageDelay_label.place(x=940, y=93)
...
btn=tk.Button(window, height=1, width=7, text="Check Now", font=('SF Pro Display',10), bg='#0f94d2', fg="#FFF", borderwidth = 0, highlightthickness = 0, command=Check_now)
btn.place(x=1090, y=92)
...
btnInstall=tk.Button(window, height=1, width=7, text="Last Update", font=('SF Pro Display',10), bg='orange', fg="#000", borderwidth = 0, highlightthickness = 0, command=log)
btnInstall.place(x=1180, y=92)
...
btnInstall=tk.Button(window, height=1, width=8, text="Exclude AUR", font=('SF Pro Display',10), bg='#dfd', fg="#b0b3b8", borderwidth = 0, highlightthickness = 0, command=install_pac)
btnInstall.place(x=400, y=405,)

# bottom install updates
def install_Updates():
    os.system('/home/' + username + '/.local/share/Archmain/bin/aur.sh')
    
btnInstall=tk.Button(window, height=1, width=5, text="Install", font=('SF Pro Display',10), bg='#dfd', fg="#b0b3b8", borderwidth = 0, highlightthickness = 0, command=install_Updates)
btnInstall.place(x=600, y=405,)
