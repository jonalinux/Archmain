...
image = tk.PhotoImage(file="/home/" + username + "/.local/share/Archmain/bin/logo.png")
...
content = open(file="/home/" + username + "/.local/share/Archmain/bin/listaupds")
...
lastcheck = open(file="/home/" + username + "/.local/share/Archmain/bin/info_lastcheck")
